...
def classic_mode(increment, decrement, reset, enter, edit, home, away, home_led, away_led, start_stop_home, start_stop_away, h_bu, a_bu): # noqa
    ...
    classic_group = initialize_classic_screen(home_score, away_score, player_one_wins, player_two_wins)
